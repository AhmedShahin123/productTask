            ...
            <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                      {!! Form::open(['method'=>'POST', 'action'=>'Admin\UsersController@store', 'files'=>true, 'class' => 'section general-info', 'id' => 'general-info']) !!}
                                                ...
                                                <div class="form">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control mb-4" id="mobile" name="phone" placeholder="Phone" value="">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
